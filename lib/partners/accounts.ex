defmodule Partners.Accounts do
  @moduledoc """
  ...
  alias Partners.Accounts.{User, UserToken, UserNotifier}
  ...
  See `Partners.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Partners.Accounts.User.password_changeset/3` for a list of supported options.
