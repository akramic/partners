defmodule PartnersWeb.UserLive.Registration do
      ...
      <div class="mx-auto max-w-sm">
        ...
        <.form for={@form} id="registration_form" phx-submit="save" phx-change="validate">
          ...
          <.button variant="primary" phx-disable-with="Creating account..." class="w-full">
            <span class="">Create an account</span><span aria-hidden="true">→</span>
          </.button>
        </.form>
      </div>
  ...
  def mount(_params, _session, %{assigns: %{current_scope: %{user: user}}} = socket)
    ...
    {:ok, redirect(socket, to: PartnersWeb.UserAuth.signed_in_path(socket))}
  end
