defmodule PartnersWeb.CustomComponents.Atoms do
  ...
  @doc """
  A speech bubble component with a tail pointing to the left.
  Used for dialogue that comes from the left side of the screen.
  """
  slot :inner_block,
    required: true,
    doc: "Inner block for text content"
  ...
  @doc """
  A speech bubble component with a tail pointing to the right.
  Used for dialogue that comes from the right side of the screen.
  """
  slot :inner_block,
    required: true,
    doc: "Inner block for text content"
  ...
  @doc """
  A dialogue component with the kangaroo logo on the left and a speech bubble.
  Used for messages or dialogue presented by the company mascot.
  """
  slot :inner_block,
    required: true,
    doc: "Inner block for text content"
  ...
  @doc """
  A dialogue component with the mirrored kangaroo logo on the right and a speech bubble.
  Used for responses or dialogue directed towards the company mascot.
  """
  slot :inner_block,
    required: true,
    doc: "Inner block for text content"
  ...
  @doc """
  A full-page loading overlay with the company logo and a loading spinner.
  Used during loading states to provide visual feedback to users.
  """
  ...
  def full_page_loader(assigns) do
    ...
    >
      <div
        ...
        aria-live="polite"
      >
        <div class="w-12 animate-bounce" aria-hidden="true">
          <.company_logo />
        </div>
        {render_slot(@inner_block)}
  ...
  @doc """
  A full-page modal overlay with the company logo.
  Used for full-screen dialogs or important messages.
  """
  slot :inner_block,
    required: false,
    doc: "Optional inner block for additional content or styling"
  ...
  @doc """
  The company logo component showing a kangaroo mascot.
  Used throughout the application for branding purposes.
  """
  def company_logo(assigns) do
    ...
    <svg
      ...
      viewBox="0 0 1280 1016"
      aria-label="Loving Partners company logo featuring a kangaroo"
      role="img"
    >
  ...
  @doc """
  A mirrored version of the company logo component.
  Used in dialogue components where the mascot needs to face the opposite direction.
  """
  def company_logo_mirror(assigns) do
    ~H"""
    <svg
      xmlns="http://www.w3.org/2000/svg"
      class="object-contain"
      viewBox="0 0 1280 1016"
      aria-label="Mirrored Loving Partners company logo featuring a kangaroo"
      role="img"
